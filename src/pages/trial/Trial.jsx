  ...
  return (
    <div>
      ...
      <div className='trial-main'>
        ...
        <h1 className="warning">Come in for a free trial class by filling in the Bounce form <Link to= "https://www.bouncelife.com/events/68d5deff6335f330b14564d8" target="_blank" className="here">here!</Link> Ensure you have your QR code ready when you come to class!</h1>
